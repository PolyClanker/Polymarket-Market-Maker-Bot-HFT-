...
from config import POLYMARKET_WS_MARKET_URL, TRADING_BPS_THRESHOLD, ORDER_SIZE
...
class OrderBook:
    ...
    def _on_message(self, ws, message):
        ...
        try:
            ...
            # Handle both single messages (dict) and batched messages (list)
            ...
            for msg in messages:
                ...
                if event_type == "book":
                    self._update_order_book_snapshot(msg)
